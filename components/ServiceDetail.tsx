    ...
    <div className="pt-0">
          ...
          <RevealOnScroll direction="up">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                <div className="max-w-4xl">
                    ...
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-heading font-bold mb-6 leading-none tracking-tight">
                    {category.title}
                    </h1>
                    
                    <p className="text-lg md:text-xl text-gray-200 font-light leading-relaxed border-l-4 border-secondary/50 pl-6 max-w-2xl">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <RevealOnScroll>
             <div className="mb-16 text-center max-w-3xl mx-auto">
               <span className="text-secondary font-bold tracking-widest uppercase text-xs mb-3 block">Expert Capabilities</span>
               <h2 className="text-3xl md:text-4xl font-heading font-bold text-primary mb-4">Specialized Services</h2>
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-8 md:p-10 flex flex-col items-start justify-end h-full z-10">
                    <div className="w-full">
                        ...
                        <div className="flex flex-col gap-5">
                            <p className="text-gray-100 text-sm md:text-base line-clamp-3 max-w-lg leading-relaxed drop-shadow-sm">
            ...
            <div className="container mx-auto px-4 max-w-7xl">
                <RevealOnScroll>
                    <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            <h2 className="text-3xl font-heading font-bold text-primary mb-2">Related Projects</h2>
                    ...
                    {categoryProjects.map((project, index) => (
                        <RevealOnScroll key={project.id} delay={index * 100} className="flex">
                            <Link 
                              ...
                              className="bg-white rounded-xl overflow-hidden shadow-md hover:-translate-y-2 hover:shadow-xl transition-all duration-300 group flex flex-col w-full h-full border border-gray-100 [mask-image:linear-gradient(white,white)]"
                            >
                                <div className="h-56 overflow-hidden relative">
                                    ...
                                    <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm p-2 rounded-full shadow-sm opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                                ...
                                <div className="p-6 flex-grow flex flex-col">
                                    ...
                                    <p className="text-textLight text-sm mb-4 flex-grow line-clamp-3">
                                        {project.description}
                                    </p>
                                    <div className="flex justify-between items-center mt-auto pt-4 border-t border-gray-50">
                                        <span className="inline-block text-textLight/70 text-xs font-bold uppercase tracking-wide">
                                            Case Study
                                        </span>
                                        <span className="text-primary font-bold text-sm group-hover:translate-x-1 transition-transform">View Details</span>
                                    </div>
                                </div>
                            </Link>
                        </RevealOnScroll>
      ...
      <section className="py-24 bg-white border-t border-gray-100 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-4xl text-center relative z-10">
           <RevealOnScroll direction="up">
             <h2 className="text-3xl md:text-4xl font-heading font-bold text-primary mb-6">Need a Custom {category.title} Solution?</h2>
             ...
             <Link 
               to="/contact" 
               className="inline-flex items-center gap-3 px-10 py-4 bg-primary text-white rounded-full font-bold uppercase tracking-wide hover:bg-secondary hover:text-dark transition-all duration-300 shadow-xl hover:shadow-primary/20 transform hover:-translate-y-1"
             >
               Contact Our Team
               <ArrowRight size={20} />
             </Link>
