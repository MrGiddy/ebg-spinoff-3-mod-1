...
export default function Hero() {
  ...
  return (
    <section 
      id="home" 
      className="h-screen min-h-[600px] relative overflow-hidden flex items-center justify-center bg-dark"
    ...
    >
      ...
      {SLIDES.map((slide, index) => (
        ...
        >
            {/* Darker overlay for better text contrast and legibility */}
      ...
      {/* Content Container */}
      <div className="container mx-auto px-4 relative z-20 text-center text-white h-full flex flex-col justify-center">
         <div className="max-w-5xl mx-auto w-full flex flex-col items-center justify-center">
            ...
            <div className="relative h-[250px] w-full mb-0 flex items-center justify-center">
                {SLIDES.map((slide, index) => (
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl drop-shadow-lg font-medium opacity-90 max-w-3xl mx-auto leading-relaxed text-gray-100">
                            {slide.subtitle}
                        </p>
                    </div>
                ))}
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-5 relative z-30 pt-2">
                ...
                {/* Secondary CTA: Glass Effect with Solid White Outline */}
                <Link 
      ...
      <button 
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 z-30 p-3 rounded-full bg-white/5 text-white border border-white/10 hover:bg-secondary hover:text-dark hover:border-secondary backdrop-blur-sm transition-all hidden md:flex"
      ...
      <button 
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-30 p-3 rounded-full bg-white/5 text-white border border-white/10 hover:bg-secondary hover:text-dark hover:border-secondary backdrop-blur-sm transition-all hidden md:flex"
